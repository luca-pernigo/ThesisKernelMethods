...
Even though their simplicity, these models have proved themselves to be really powerful, see figure \ref{fig:decision_tree} for a visualisaiton . The most popular among these model is the CART \cite{breiman2017classification} tree, its name comes from the fact that it can handle both classification and regression problems.
\begin{figure}
...
In order to get acquainted with the inner working of the presented methods, this section covers an application explaining practical details and comparing results.
\\
The dataset used is the Melbourne Daily Maximum Temperatures \cite{hdrcde}. It contains the daily maximum temperatures in Melbourne, Australia, from 1981-1990, excluding leap days.
...
- metrics pinball, picw plot, mae error
