...
Tbats forecast is visualized in Figure \ref{fig:tbats_price}, meanwhile its RMSE on task 1 is 15.08.
\begin{figure}[!h]
...
This method achieves on task 1 a RMSE of 23.96, its prediction is visualized in Figure \ref{fig:prophet_price_1}.
\begin{figure}[!h]
