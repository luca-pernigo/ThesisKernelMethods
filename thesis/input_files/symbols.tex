...
\glsxtrnewsymbol[description={Cumulative density function}]{CDF}{CDF}
...
%E
\glsxtrnewsymbol
[description={European Centre for Medium-Range Weather Forecasts}]{ECMWF}{ECMWF}
...
\glsxtrnewsymbol[description={European network of transmission system operators for electricity}]{ENTSOE}{ENTSOE}
...
%G
\glsxtrnewsymbol[description={Generalised additive models}]{GAMs}{GAMs}
...
\glsxtrnewsymbol[description={Run of river}]{ROR}{ROR}


%P
\glsxtrnewsymbol[description={Pattern analysis}]{PA}{PA}
...
\glsxtrnewsymbol[description={Probability density function}]{PDF}{PDF}
...
% D
\glsxtrnewsymbol[description={direct sum}]{oplus}{\ensuremath{\oplus}}
...
\glsxtrnewsymbol[description={feature space}]{F}{\ensuremath{\mathcal{F}}}
...
% L
\glsxtrnewsymbol[description={Lagrangian}]{L}{\ensuremath{\mathcal{L}}}
...
% T
\glsxtrnewsymbol[description={tensor product}]{otimes}{\ensuremath{\otimes}}
