...
\end{figure}
\\
EF is a heterogenous field of research, its researchers come from a wide array of backgrounds, with electrical engineers and statisticians making up the top contributors; their different educational training may explain why the split between statistical and computational intelligence methods is so marked. Figure \ref{fig:subject_area} depitcs the EF publications by subject area. What can be concluded, is that the bulk of publication come from engineering, computer science, mathematics and econometrics.
\begin{figure}
