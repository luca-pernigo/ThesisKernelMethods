...
\begin{abstract}
  ...
  % results
  Our results showed the feasibility of kernel methods in the field of electricity forecasting both in terms of point and probabilistic forecasting. In particular, in the probabilistic context, our experiments show the validity of kernel quantile regression equipped with the Laplacian kernel.
  % discussion
