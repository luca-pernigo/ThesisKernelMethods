...
if __name__=="__main__":
    # load data
    df_train=pd.read_csv("/Users/luca/Desktop/ThesisKernelMethods/dataset_applications/gefcom_price/Price/Task 4/Task4_P_train.csv")
    
    df_train=df_train[(df_train["MONTH"]==7) | (df_train["MONTH"]==6)]
    # define train
