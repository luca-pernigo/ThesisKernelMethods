...
# bash script
# for ((i=1;i<=15;i++)); do python create_test.py "/Users/luca/Desktop/ThesisKernelMethods/dataset_applications/gefcom_price/Price/Task $i/Task${i}_P.csv"; done
...
def create_test(file):
    ...
    # order columns
    df_merged=miscellaneous.order_columns(df_merged)
    # save
    ...
    df_merged.to_csv(f"/Users/luca/Desktop/ThesisKernelMethods/dataset_applications/gefcom_price/Price/Task {n}/Task{n}_P_test.csv", index=False)
