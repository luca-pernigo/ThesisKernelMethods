...
def test(ith):
    df=pd.read_csv(f"/Users/luca/Desktop/GEFCom2014 Data/Load/Task {ith}/L{ith}-avg_test_clean2.csv")
...
if __name__=="__main__":
    ...
    with open(f"/Users/luca/Desktop/ThesisKernelMethods/thesis/tables/qr_gefcom2014_w_avg2.txt", "a") as f:
        sys.stdout=f
