...
if __name__=="__main__":
    ith=15
    # load data
    df=pd.read_csv("/Users/luca/Desktop/GEFCom2014 Data/Load/L-train.csv")
    ...
    for i,q in enumerate(tqdm(quantiles)):
        ...
        pickle.dump(qr_krn_models[i], open(f'/Users/luca/Desktop/ThesisKernelMethods/dataset_applications/models_conditioned_months/task {ith} cv/krn_qr_{i}.pkl', 'wb'))
