# this script creates the testdataset with weather predicted as the average of the past 9 years
import pandas as pd

df_w=pd.read_csv(f"/Users/luca/Desktop/GEFCom2014 Data/Load/L-weather-train.csv")
