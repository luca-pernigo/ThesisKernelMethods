...
def test(ith):
    ...
    df_train=pd.read_csv("/Users/luca/Desktop/GEFCom2014 Data/Load/L2009-train_2.csv")
...
if __name__=="__main__":
    ...
    with open(f"/Users/luca/Desktop/ThesisKernelMethods/thesis/tables/qr_gefcom2014_2.txt", "a") as f:
        sys.stdout=f
